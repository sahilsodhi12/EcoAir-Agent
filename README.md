...
Perceive environmental sensor readings.
Predict CO concentration using a learned Random Forest model.
Interpret the predicted CO value using a project-level decision policy.
Act by selecting one of three monitoring actions:
Monitor
Warning
Alert
---
